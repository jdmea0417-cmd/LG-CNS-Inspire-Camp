...
/*
Filter ?
- 특정 endPoint에 접근할 때 토큰의 유무를 판단

??
상황에 따라서 토큰 유무를 판단하지 않는 endPoint도 있다 : white list
*/
@Component
public class JwtFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
    ...
    System.out.println("debug >>>> JwtFilter user request path(method) : " + method);
    ...
    // whiet list 등록되지 않은 endPoint 접근이 발생한다면?
